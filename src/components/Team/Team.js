...
export default function Team() {
  return (
    ...
    <section>
        ...
        <div class="service2">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRywTiADNQ0rCoZgZi59mdCfb_qERY46gRvcw&usqp=CAU" alt="cheap price" />
            <h3>cheap price</h3>
            <p>our design is the cheapest, we creat it from scratch</p>
        </div>
        <div class="service3">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRMqveFbx0ZeouOg1v1vOgQOlejaBBtcazNg&usqp=CAU" alt="preformance" />
            <h3>amazing preformance</h3>
            <p>our code is clean and professional, the speed and preformance is our target</p>
        </div>
    </section>
